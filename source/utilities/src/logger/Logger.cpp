...
Logger* Logger::getInstance(void)
{
    ...
    if (nullptr == mp_logger)
    {
        ...
        ErrorHandler::getInstance()->handleError((nullptr == mp_logger),
                                                 __FILE__, __PRETTY_FUNCTION__,
                                                 __LINE__, ERROR_ALLOCATION);
    }
...
bool Logger::logMsg(std::string* msg)
{
    ...
    ErrorHandler::getInstance()->handleError((nullptr == msg), __FILE__,
...
///
////////////////////////////////////////////////////////////////////////////////
Logger::Logger(void) : m_logFileName("CodeWebLog.txt")
{
    // --- Open the log file
